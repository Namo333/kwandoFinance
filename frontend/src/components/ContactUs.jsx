        ...
        <div class="">
          <div class="max-w-5xl px-4 xl:px-0 py-10 lg:py-20 mx-auto">
            <div class="max-w-3xl mb-10 lg:mb-14">
              ...
              <p class="mt-1 text-neutral-400">Какой бы ни была ваша цель – мы доставим вас туда.</p>
            </div>
              ...
              <div class="space-y-14">
                ...
                <div class="flex gap-x-5">
                  ...
                  <div class="grow">
                    ...
                    <p class="mt-1 text-neutral-400">Найдите ответы на все ваши вопросы в нашем разделе часто задаваемых вопросов.</p>
                    <p class="mt-2">
