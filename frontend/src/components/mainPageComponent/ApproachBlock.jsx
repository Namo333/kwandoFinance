        ...
        <div class="xl:px-0 py-5 lg:pb-20 mx-auto">
            ...
            <div>
                ...
                <div class="flex gap-x-5 ms-1">
                    ...
                    <button type="button" class="group inline-flex items-center gap-x-2 py-2 px-3 bg-blue-600 font-medium text-sm text-white rounded-[13px] focus:outline-none" href="#">
